<%@ Page Title="AdminLTE | Dashboard" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="WebApplication1.index" %>
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <p>Hello,  <asp:Label ID="Label2" runat="server"></asp:Label></p>
                        ...
                        <section class="col-lg-6 connectedSortable"> 
                            ...
                            <div class="box-body no-padding">
                                    <div class="table-responsive">
                                        ...
                                        <center>
                                            <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Editor.aspx">Editor</asp:HyperLink>
                                        </center>
